...
REM
REM Generated by Vivado on Wed Sep 03 14:20:57 +0700 2025
...
echo "xvlog --incr --relax -prj tb_mul_poly_matrix_vlog.prj"
call xvlog  --incr --relax -prj tb_mul_poly_matrix_vlog.prj -log xvlog.log
