...
HD_PWD='C:/Hung/Viettel/Stage2/ML-KEM/mul_poly/mul_matrix/mul_matrix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_cel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_cel.tcl
